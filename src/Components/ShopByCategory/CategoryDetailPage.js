...
// import { categoriesData } from './categoriesData'; // Mock categories data
// import { FaHeart } from 'react-icons/fa';
// import { FaCheck } from 'react-icons/fa'; // Import the checkmark ic
...
//   if (loading) {
//     return (
//       <div className="font-fira text-center text-4xl p-8 m-5">Loading...</div>
//     );
//   }
...
//                   </h3>
//                   <p className="text-sm text-orange-500 hover:text-orange-700">
//                     {" "}
//                     Company:
