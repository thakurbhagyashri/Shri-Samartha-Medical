...
//         {/* Link for Category Title */}
//         <Link
//             to="/all-categories" // Link to the specific category page
//             className="text-lg text-gray-800 hover:text-blue-500 no-underline"
//         >
//             Categories {/* Assuming categoryName is the name of the current category */}
//         </Link>
//     </h3>
//                 <ul>
...
const CategoryDetailPage = () => {
  ...
  return (
    <div className="flex">
      <div className="w-1/6 bg-gray-100 p-4">
        <h3 className="text-xl font-semibold mb-4">
          <Link to="/all-categories" className="text-lg text-gray-800 hover:text-blue-500 no-underline">
            Categories
          </Link>
        </h3>
        <ul>
          {categoriesData.map((cat) => (
            <li key={cat.id} className="mb-2">
              <Link to={`/category/${cat.name}`} className="text-lg text-gray-800 hover:text-blue-500">
                {cat.name}
              </Link>
            </li>
          ))}
      ...
      <div className="w-3/4 p-6">
        <h2 className="text-3xl font-semibold mb-8">Products in {category.name} Category</h2>
        <div className="mb-6 flex items-center space-x-4">
          <input
            type="text"
            placeholder="Search for products"
